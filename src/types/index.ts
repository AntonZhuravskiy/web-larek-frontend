...
export type CardPurchaseState = 'UNAVAILABLE' | 'NOT_IN_BASKET' | 'IN_BASKET';

export interface CardState {
	product: IProduct;
	available: boolean; // price !== null
	inBasket: boolean; // лежит ли товар в корзине
	purchaseState: CardPurchaseState;
	buttonEnabled: boolean; // включать ли кнопку "Купить"
}
